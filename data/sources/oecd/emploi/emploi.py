...
config = {
    ...
    "preprocesser": {
        'fns': {
            "Part-des-employés-à-temps-partiel-involontaire-par-sexe-et-groupe-d'âge.csv": "get_wm_then_percRel1",
            "Taux-d'activité-par-sexe-et-groupe-d'âge.csv": "get_wm_then_percRel100",
            # "Rapport-emploi-population-par-sexe-et-groupe-d’âge.csv": "get_wm_then_percRel100",
            "Part-des-employés-à-temps-partiel-par-sexe-et-groupe-d'âge.csv": "get_wm_then_percRel100",
            "Part-des-employés-temporaires-par-sexe.csv": "get_wm_then_percRel100",
            "Part-de-l'emploi-dans-l'agriculture-par-sexe-.csv": "get_wm_then_percRel100",
            "Part-de-l'emploi-dans-l'industrie-par-sexe.csv": "get_wm_then_percRel100",
            "Part-de-l'emploi-dans-les-services-par-sexe.csv": "get_wm_then_percRel100",
            # "Nombre-potentiel-d'années-à-la-retraite-par-sexe.csv": "get_wm_then_percRel100",
            # "Durée-du-congé-de-maternité.csv": "get_wm_then_percRel100",
            # "Durée-du-congé-parental-avec-protection-de-l'emploi.csv": "get_wm_then_percRel100",
           # "Durée-totale-du-congé-de-maternité-et-parental-payés.csv": "get_wm_then_percRel100",
            # "Durée-du-congé-payé-réservé-aux-pères.csv": "get_wm_then_percRel100",
            "Part-des-employés-cadres-supérieurs-par-sexe.csv": "get_wm_then_percRel100",
            # "Part-des-femmes-au-conseil-d'administration-des-plus-grandes-sociétés-cotées-en-bourse.csv": "get_wm_then_percRel100",
            "Taux-de-chômage-par-sexe-et-groupe-d'âge.csv": "get_wm_then_percRel100",
            # "Taux-d'emploi-équivalent-plein-temps-par-sexe.csv": "get_wm_then_percRel100",
        },
        'rename': {
            'country': 'Pays',
            'year': 'TIME',
    ...
    "mapper": {
        'fns': {
            ...
            "Part-des-employés-temporaires-par-sexe.csv": "diffFH_100",
            "Part-de-l'emploi-dans-l'agriculture-par-sexe-.csv": "diffFH_100",
            "Part-de-l'emploi-dans-l'industrie-par-sexe.csv": "diffFH_100",
            "Part-de-l'emploi-dans-les-services-par-sexe.csv": "diffFH_100",
            # "Nombre-potentiel-d'années-à-la-retraite-par-sexe.csv": "diffFH_100",
            # "Durée-du-congé-de-maternité.csv": "diffFH_100",
            # "Durée-du-congé-parental-avec-protection-de-l'emploi.csv": "diffFH_100",
           # "Durée-totale-du-congé-de-maternité-et-parental-payés.csv": "diffFH_100",
            # "Durée-du-congé-payé-réservé-aux-pères.csv": "diffFH_100",
            "Part-des-employés-cadres-supérieurs-par-sexe.csv": "diffFH_100",
