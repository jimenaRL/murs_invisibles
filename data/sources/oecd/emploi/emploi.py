...
config = {
    ...
    "preprocesser": {
        'fns': {
            "Part-des-employés-à-temps-partiel-involontaire-par-sexe-et-groupe-d'âge.csv": "get_wm_then_insee_1",
            "Taux-d'activité-par-sexe-et-groupe-d'âge.csv": "get_wm_then_insee_100",
            # "Rapport-emploi-population-par-sexe-et-groupe-d’âge.csv": "get_wm_then_insee_100",
            "Part-des-employés-à-temps-partiel-par-sexe-et-groupe-d'âge.csv": "get_wm_then_insee_100",
            "Part-des-employés-temporaires-par-sexe.csv": "get_wm_then_insee_100",
            "Part-de-l'emploi-dans-l'agriculture-par-sexe-.csv": "get_wm_then_insee_100",
            "Part-de-l'emploi-dans-l'industrie-par-sexe.csv": "get_wm_then_insee_100",
            "Part-de-l'emploi-dans-les-services-par-sexe.csv": "get_wm_then_insee_100",
            # "Nombre-potentiel-d'années-à-la-retraite-par-sexe.csv": "get_wm_then_insee_100",
            # "Durée-du-congé-de-maternité.csv": "get_wm_then_insee_100",
            # "Durée-du-congé-parental-avec-protection-de-l'emploi.csv": "get_wm_then_insee_100",
           # "Durée-totale-du-congé-de-maternité-et-parental-payés.csv": "get_wm_then_insee_100",
            # "Durée-du-congé-payé-réservé-aux-pères.csv": "get_wm_then_insee_100",
            "Part-des-employés-cadres-supérieurs-par-sexe.csv": "get_wm_then_insee_100",
            # "Part-des-femmes-au-conseil-d'administration-des-plus-grandes-sociétés-cotées-en-bourse.csv": "get_wm_then_insee_100",
            "Taux-de-chômage-par-sexe-et-groupe-d'âge.csv": "get_wm_then_insee_100",
            # "Taux-d'emploi-équivalent-plein-temps-par-sexe.csv": "get_wm_then_insee_100",
        },
        'rename': {
            'country': 'Pays',
            'year': 'TIME',
