...
config = {
    ...
    "preprocesser": {
        'fns': {
            "Part-des-employés-à-temps-partiel-involontaire-par-sexe-et-groupe-d'âge.csv": "diff_wm_insee",
            "Taux-d'activité-par-sexe-et-groupe-d'âge.csv": "diff_wm_insee",
            # "Rapport-emploi-population-par-sexe-et-groupe-d’âge.csv": "diff_wm_insee",
            "Part-des-employés-à-temps-partiel-par-sexe-et-groupe-d'âge.csv": "diff_wm_insee",
            "Part-des-employés-temporaires-par-sexe.csv": "diff_wm_insee",
            "Part-de-l'emploi-dans-l'agriculture-par-sexe-.csv": "diff_wm_insee",
            "Part-de-l'emploi-dans-l'industrie-par-sexe.csv": "diff_wm_insee",
            "Part-de-l'emploi-dans-les-services-par-sexe.csv": "diff_wm_insee",
            # "Nombre-potentiel-d'années-à-la-retraite-par-sexe.csv": "diff_wm_insee",
            # "Durée-du-congé-de-maternité.csv": "diff_wm_insee",
            # "Durée-du-congé-parental-avec-protection-de-l'emploi.csv": "diff_wm_insee",
           # "Durée-totale-du-congé-de-maternité-et-parental-payés.csv": "diff_wm_insee",
            # "Durée-du-congé-payé-réservé-aux-pères.csv": "diff_wm_insee",
            "Part-des-employés-cadres-supérieurs-par-sexe.csv": "diff_wm_insee",
            # "Part-des-femmes-au-conseil-d'administration-des-plus-grandes-sociétés-cotées-en-bourse.csv": "diff_wm_insee",
            "Taux-de-chômage-par-sexe-et-groupe-d'âge.csv": "diff_wm_insee",
            # "Taux-d'emploi-équivalent-plein-temps-par-sexe.csv": "diff_wm_insee",
        },
        'rename': {
            'country': 'Pays',
            'year': 'TIME',
    ...
    "mapper": {
        'fns': {
            "Part-des-employés-à-temps-partiel-involontaire-par-sexe-et-groupe-d'âge.csv": "ecart100",
